...
- **Sidebar:** el enlace "Cotizaciones" en `resources/views/layout/masteradmin.blade.php`
  apunta a `admin/cash` (heredado). Debería apuntar a `admin/quotation`. No se corrigió
  aquí para no tocar un archivo ya modificado fuera de esta tarea.
