                                            ...
                                            <table id="DataTables_Table_CRUD" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="sort" data-sort="ci">Carnet</th>
                            ...
                            <div class="modal-content">
                                ...
                                <form id="Form" name="Form">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="lastname-field" class="form-label">Autor</label>
                                            <input type="lastname" id="lastname" name="lastname" class="form-control" placeholder="Enter lastname" required />
                                        </div>
