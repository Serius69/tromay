...
class UpdateCashRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // sell >= buy: un spread invertido hace que la casa pierda en cada operación.
            'sell'    => ['required', 'numeric', 'min:0', 'max:99999999', 'gte:buy'],
    ...
    public function messages(): array
    {
        return [
            ...
            'sell.gte'        => 'La tasa de venta no puede ser menor que la de compra (spread invertido).',
