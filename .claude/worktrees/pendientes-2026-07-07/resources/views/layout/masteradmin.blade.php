        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ms-1 header-item d-flex align-items-center">
                    @auth
                        <span class="d-none d-md-inline text-muted me-2 fs-13">{{ auth()->user()->name }}</span>
                    @endauth
                    <form method="POST" action="{{ route('logout') }}" class="m-0">
                        @csrf
                        <button type="submit" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle shadow-none"
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarCash">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ url('admin/cash') }}" class="nav-link" data-key="t-calendar"> Divisas y Tasas </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
